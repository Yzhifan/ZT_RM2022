...
int16_t yaw_loops_pid(Error_position *angle_error,Error_position *gyro_error,int16_t position_exp,int16_t feedback1,int16_t feedback2)
{
	...
	{
		/*串级pid外环角度环计算*/
		position_out1 = Position_Aangle_pid(angle_error,feedback1,position_exp,0.3,0,0.1);//0.3 0 0.1
    
		yaw_scale = 0;
	}
	
	/*串级pid内环角速度环计算*/
	position_out2 = Position_Gyro_pid(gyro_error,feedback2,position_out1,14,0.01,0); //32 0.02 5
...
int16_t pitch_loops_pid(Error_position *angle_error,Error_position *gyro_error,int16_t position_exp,int16_t feedback1,int16_t feedback2)
{
	...
	{
		/*串级pid外环角度环计算*/
		position_out1 = Position_Aangle_pid(angle_error,feedback1,position_exp,0.8,0,0);
		
		pitch_scale = 0;
	}

	/*串级pid内环角速度环计算*/
	position_out2 = Position_Gyro_pid(gyro_error,feedback2,position_out1,3.2,0.02,0);
